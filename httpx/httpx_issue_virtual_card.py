...
# Шаг 4. Полуение документов
get_tariff_documebt = httpx.get(f"{base_url}api/v1/documents/tariff-document/{account_id}")
print(f"Response get_tariff_document: {get_tariff_documebt.json()}")
print(f"Staus code get_tariff_document: {get_tariff_documebt.status_code}")

get_contract_document = httpx.get(f"{base_url}api/v1/documents/contract-document/{account_id}")
print(f"Response get_contract_document: {get_contract_document.json()}")
print(f"Staus code get_contract_document: {get_contract_document.status_code}")