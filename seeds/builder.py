from clients.grpc.gateway.accounts.account_client import build_accounts_gateway_grpc_client, AccountsGatewayGRPCClient
from clients.grpc.gateway.cards.cards_client import build_cards_gateway_grpc_client, CardsGatewayGRPCClient
from clients.grpc.gateway.operations.operations_client import build_operations_gateway_grpc_client, OperationsGatewayGRPCClient
from clients.grpc.gateway.users.users_client import build_users_gateway_grpc_client, UsersGatewayGRPCClient
from clients.http.gateway.accounts.accounts_client import build_accounts_gateway_http_client, AccountsGatewayHTTPClient
from clients.http.gateway.cards.cards_client import build_cards_gateway_http_client, CardsGatewayHTTPClient
from clients.http.gateway.operations.operation_client import build_operations_gateway_http_client, OperationsGatewayHTTPClient
from clients.http.gateway.users.user_client import build_users_gateway_http_client, UsersGatewayHTTPClient
...
class SeedsBuilder:
    ...
    def build_transfer_operation_result(self, card_id: str, account_id: str) -> SeedOperationResult:
        ...
        return SeedOperationResult(operation_id=response.operatio.id)
